...
export const EditForm = ({props}) => {
  ...
  const { date: ticketDate, note: ticketNote, _id, firstname, surname, lastname, email, phone, service, user, serviceType } = ticket[0]
    ...
    <div className={styles.popup}>
        <div className={styles.PopupModal}>
            ...
            <div className={styles.PopupContent}>
                <h4>Редактирование записи</h4>
                    ...
                    <div className={styles.content}>
                        ...
                        <p>{serviceType === 'consultation' ? 'Консультация' : 'Подача документов'}</p>
                    </div>
            ...
            <div className="modal-footer">
                ...
                <button className={["modal-close  btn-flat btn green", styles.Button].join(" ")}  onClick={closeForm} >
                Закрыть
                </button>
            </div>
        </div>
